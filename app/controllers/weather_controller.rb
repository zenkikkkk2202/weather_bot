  ...
  def callback
    ...
    events.each { |event|
      ...
      if event.message['text'].include?("天気")
        ...
        # response = area = `curl -X GET https://api.gnavi.co.jp/RestSearchAPI/v3/?keyid=161a20d6368441dd8e7d27c1aa717317&format=json&address=#{area}`
        response = "https://api.gnavi.co.jp/RestSearchAPI/v3/?keyid=161a20d6368441dd8e7d27c1aa717317&format=json&address=#{area}"
      else
        # おうむ返し
        event.message['text']
