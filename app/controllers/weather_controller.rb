  ...
  def callback
    ...
    events.each { |event|
      ...
      if event.message['text'].include?("天気")
        ...
        place = event.message['text'].delete("ぐるなび")
        response = area = `curl -X GET https://api.gnavi.co.jp/RestSearchAPI/v3/?keyid=161a20d6368441dd8e7d27c1aa717317&address=#{place}`
